    ...
    if (isset($_POST["save"])) {
        ...
        if ($password == $confirm_password) {
            ...
            $sql = "INSERT INTO userlist(username, access, email, organization, contact, profile_picture, password)
                    VALUES(:username, 'user', :email, :organization, :contact, :profile_picture, :password)";
            $result = $pdo->prepare($sql);
...
<head>
    ...
    <link rel="stylesheet" href="orgadduser.css">
    ...
    <body>
          ...
          <div class="profile-container">
            ...
            <form action="" method="post" enctype="multipart/form-data" autocomplete="off">
                ...
                <button class="save" type="submit" name="save">Add User</button>
            </form>
