...
try {
    ...
    if (isset($_POST["post"])) {
        ...
        if ($updateSuccess) {
            ...
            $auditSql = "INSERT INTO audit_trail(`action`, `user_id`) VALUES('Organization admin updated post', :user_id)";
...
<head>
    ...
    <link rel="stylesheet" href="orgeditpost.css">
    ...
    <body>
          <div class="header">
            ...
            <div class="right-section">
                ...
                <div class="user-name">
                  <a href="orgadminprofile.html" ><?php echo $user["username"]; ?></a> <!-- <?php echo $post['username']; ?> -->
              </div>
