...
<head>
    ...
    <link rel="stylesheet" href="orgeventlist.css">
  ...
  WHERE a.org = :organization OR u.church_member != 'no' -- Modify to get future events
                        ...
                        <div>
                          <div class="user-profile">
                            ...
                            <div class="poster-info">
                              ...
                              <a href="orgexpandpost.php?id=<?php echo $log['post_id'];?>" id="logo-link" title="Expand post">
                  ...
                  <div class="user-post-description">
                    ...
                    <div class="post-when">  Location:      <?php echo $log['location'];?></div>
                      ...
                      <div class="mga-buttons">
                        <a href="orgeditpost.php?id=<?php echo $log['post_id'];?>" target="_blank">Edit</a>
                        </div>
