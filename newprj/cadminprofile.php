                ...
                if ($_FILES["profile_picture"]["error"] === 4) {
                    ...
                    if (!in_array($image_extension, $valid_image_extension)) {
                        ...
                        try {
                            ...
                            if ($stmt) {
                                $sql = "INSERT INTO audit_trail(`action`, `user_id`) VALUES('Church Admin updated profile', :user_id)";
                                $result = $pdo->prepare($sql);
...
<head>
    ...
    <link rel="stylesheet" href="cadminprofile.css">
    ...
    <body>
          ...
          <div class="profile-container">
            <h2> <!-- <?php echo $user['username']; ?>'s --> Charles Berc's Profile</h2>
            <div class="profile-picture-container">
                <img class="profile-picture" src="images/logos/catpro.png" alt="">
