        ...
        if ($password == $confirm_password) {
            ...
            if ($result->execute()) {
                echo "<script>
                    alert('User added');
                    setTimeout(function() {
                        window.location.href = 'superadminhome.php';
...
<head>
    ...
    <body>
          ...
          <div class="welcome-text"><h1>Welcome Super Admin!</h1> </div>
          <div class="profile-container">
            <h2> Add Church Admin Account</h2>
            
    
            <form action="" method="post" enctype="multipart/form-data" autocomplete="off">
                <label for="Create_church">Organization Name:</label>
                <input type="text" name="organization" id="Create_church" placeholder="Enter church here" required>
